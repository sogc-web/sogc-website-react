...
const Loader = ({ text, size = 'medium', fullScreen = false }) => {
  const sizeClass = {
    small: 'loader__size loader__size--small',
    medium: 'loader__size loader__size--medium',
    large: 'loader__size loader__size--large'
  }[size] || 'loader__size loader__size--medium';
  ...
  return (
    <div className={containerClass}>
      <div className={sizeClass}>
        <svg className="bike" viewBox="0 0 48 30" width="100%" height="100%">
